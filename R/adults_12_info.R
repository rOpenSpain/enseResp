#' @title adults_12_info
#' @description Design of the survey. Variable characteristics of adult survey ENSE 2011/12.
#' @format A data frame with 577 rows and 6 variables:
#' \describe{
#'   \item{\code{campo}}{variable name}
